...
export function Hero() {
  ...
  return (
    <div className="relative flex flex-row items-start">
      {/* Hero Section */}
      <div id="home" className="flex flex-col items-center justify-center h-[40rem] flex-1">
      ...
      <div className="relative -mt-4 ml-4">
        <img 
          src="https://lh3.googleusercontent.com/d/1ttsxjf0R_Ypwf_r7h5AuMD0kTN5a88ER" 
          alt="Meri Jaan" 
          className="h-[38rem] w-auto max-w-none object-cover"
          style={{
            maskImage: 'linear-gradient(to right, transparent 0%, black 20%, black 100%), linear-gradient(to bottom, transparent 0%, black 8%, black 92%, transparent 100%)',
            WebkitMaskImage: 'linear-gradient(to right, transparent 0%, black 20%, black 100%), linear-gradient(to bottom, transparent 0%, black 8%, black 92%, transparent 100%)',
